...
const StudentLayout = ({ children }: StudentLayoutProps) => {
  ...
  const navItems = [
    ...
    { name: "Book Meals", path: "/student/book" },
    { name: "My Coupons", path: "/student/coupons" },
    { name: "Payment History", path: "/student/payments" },
  ];
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              <Link to="/student/dashboard" className="flex items-center gap-2">
                <MealIcon className="h-6 w-6 text-green-600" />
                <span className="text-xl font-bold text-gray-800">Mess Management</span>
              </Link>
            </div>
